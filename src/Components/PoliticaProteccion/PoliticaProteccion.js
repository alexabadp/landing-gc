      ...
      <div className="container container-politica">
        <div className="row">
          <div className="col-lg-12">
            ...
            <p>
              Trilce se obliga a que de los datos personales obtenidos a través
              de formularios del portal web, cuenten previamente con el
              consentimiento expreso del titular para recopilar su información,
              los cuales serán tratados única y específicamente para la
            ...
            <ol>
              <li>
                ...
                información de Trilce y serán tratados para poder llevar a cabo
                sus finalidades.
              </li>
              <li>
                Trilce no empleará los datos personales del Usuario para ninguna
                finalidad distinta a la que fueron suministrados, a no ser que
                se trate de una finalidad expresamente permitida o exigida por
                la normativa vigente aplicable, por orden judicial o una
              ...
              <li>
                ...
                en dichos portales web para verificar el nivel de protección de
            ...
            <p>
              ...
              confidencialidad de los datos personales; los cuales serán
            ...
            <ol>
              ...
              <li>
                ...
                perjuicios, directo o indirecto que genere a Trilce y/o terceros
                por incumplir total o parcialmente lo señalado en el punto
                anterior.
              </li>
            </ol>
            <h1 className="content-subtitle">
            ...
            <p className="last-parragraph">
              ...
              adaptarla a futuros cambios que pueda requerir el marco normativo
              vigente, brindar una mejor calidad de servicio o comunicar nuevas
              alternativas relacionadas a la presente Política. Es
              responsabilidad del Usuario mantenerse informado sobre los cambios
              que se introduzcan a esta Política de Privacidad publicando en
              este Sitio la versión actualizada o modificada de la misma.
            </p>
          </div>
        </div>
      </div>

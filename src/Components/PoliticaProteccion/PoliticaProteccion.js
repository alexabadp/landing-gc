        ...
        <div className="row">
          <div className="col-lg-12">
            ...
            <p>
              ...
              autorizado y robo de los datos facilitados por los usuarios.
            </p>
            ...
            <ol>
              <li>
                Datos personales: Toda información sobre una persona natural que
                la identifica o hace identificable a través de medios que pueden
              ...
              <li>
                ...
                utilización, bloqueo, supresión, comunicación por transferencia
                o por difusión o cualquier otra forma de procesamiento que
            ...
            <p>
              Grupo Ciencias se obliga a que de los datos personales obtenidos a
              través de su web, cuenten previamente con el consentimiento
              expreso del titular para recopilar dicha información, la cual será
              tratada única y específicamente para la finalidad solicitada.
            </p>
            ...
            <ol>
              <li>
                ...
                información de Grupo Ciencias y serán tratados para poder llevar
                a cabo sus finalidades.
              </li>
              <li>
                Grupo Ciencias no empleará los datos personales del Usuario para
                ninguna finalidad distinta a la que fueron suministrados, a no
                ser que se trate de una finalidad expresamente permitida o
                exigida por la normativa vigente aplicable, por orden judicial o
              ...
              <li>
                ...
                este último, salvo cuando dicha comunicación sea exigida por la
              ...
              <li>
                ...
                responsabilidad del Usuario revisar las políticas de privacidad
                en dichos sitios web para verificar el nivel de protección de
                sus datos personales en ese ambiente, lo que es ajeno a la
                responsabilidad de Grupo Ciencias.
              </li>
            </ol>
            <div ref={bottomRef}>
            ...
            <p>
              Grupo Ciencias se compromete a brindar todas las medidas técnicas,
              legales y administrativas necesarias para garantizar la seguridad
              y confidencialidad de los datos personales; los cuales serán
              tratados considerando los principios de legalidad, consentimiento,
              proporcionalidad, calidad, seguridad y los demás presentes en la
              normativa vigente referente a protección de datos personales,
              evitando que estos sean filtrados, difundidos o cualquier acción
              que ponga en peligro su información personal.
            </p>
            ...
            <ol>
              <li>
                ...
                protegidos que pueda ejercer el Titular de los Datos Personales,
                para lo cual deberá mantener disponibles canales, procedimientos
                e información para atender las solicitudes en los plazos
                establecidos por las Normas de Protección de Datos Personales.
              </li>
              <li>
                El Usuario podrá ejercer sus derechos de Información, Acceso,
                Rectificación, Cancelación, Oposición, etc. (ARCO) al uso de sus
                datos personales, de conformidad con la Ley de Protección de
                Datos Personales, Ley N° 29733. En ese sentido, el Usuario tiene
                derecho, entre otros, a acceder a su información personal, a
                solicitar la rectificación de datos inexactos y a revocar su
                consentimiento para el tratamiento de la misma; asimismo, podrá
                solicitar la supresión de sus datos u oponerse al tratamiento de
                los mismos, incluso cuando estos ya no resulten necesarios para
                los fines que motivaron su recopilación.
              </li>
              <li>
                ...
                escaneo en PDF del documento de identidad (DNI/CE/Pasaporte) que
                acredite su titularidad sobre los datos personales respecto de
                los cuales ejercerá su derecho. También podrá hacerlo
                acercándose a la sede de Comas (Av. Universitaria 6403). Si
                utiliza un representante legal, éste deberá acreditarse como
                tal.
              </li>
              <li>
            ...
            <p className="last-parragraph">
              ...
              comunicar nuevas alternativas relacionadas a la presente Política.
              Es responsabilidad del Usuario mantenerse informado sobre los
              cambios que se introduzcan a esta Política de Privacidad
              publicando en este Sitio la versión actualizada o modificada de la
              misma.
            </p>
          </div>
        </div>

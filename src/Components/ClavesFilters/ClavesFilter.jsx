...
import ClavesTable from "../ClavesTable/ClavesTable";
...
const ClavesFilters = () => {
  ...
  const handleChangeAnio = (event) => {
    ...
    return new Promise((resolve, reject) => {
      fetch(
        "https://grupociencias.edu.pe:8080/api.grupociencias.admin/api/biblioteca/claves/listar/",
        {
          method: "POST",
          headers: {

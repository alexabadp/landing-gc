...
export default function MaterialTable({ dataTable }) {
  ...
  const [nombreMaterialValue, setNombreMaterialValue] = React.useState("");
  ...
  const handleSendEmail = () => {
    ...
    let templateParams = {
      ...
      body_mail: `Tiene un nuevo reporte de archivo caido en Materiales, el nombre del archivo es el siguiente => ${nombreMaterialValue}.`,
    };
    emailjs
      .send(
        "service_42isdsd",
  ...
  const handleCellAlert = (nombreMaterial) => {
    setNombreMaterialValue(nombreMaterial);
    setOpen(true);
  };

  const handleClose = () => {
    setOpen(false);
    setNombreMaterialValue("");
  };
              ...
              {dataTable
                ...
                .map((row) => (
                  ...
                  >
                    ...
                    <TableCell
                      align="center"
                      onClick={() => handleCellAlert(row.nombre_material)}
